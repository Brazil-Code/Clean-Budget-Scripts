...
ALTER SEQUENCE "USER_id_seq" RENAME TO "USER_seq";
...
CREATE TABLE PURCHASE_REQUEST(
        ...
        CONSTRAINT FK_PURCHASE_REQUEST_ID_CREATE_USER FOREIGN KEY (ID_CREATE_USER) REFERENCES "USER" (ID),
        CONSTRAINT FK_PURCHASE_REQUEST_ID_MANAGER FOREIGN KEY (ID_MANAGER) REFERENCES "USER" (ID)
);
